...
namespace SIS
{
    ...
    public class VRGUIArrows : MonoBehaviour
    {
        ...
        public float m_ShowAngle = 60f;           // How far from the desired facing direction the player must be facing for the arrows to appear.
        public Transform m_DesiredDirection;      // Indicates which direction the player should be facing (uses world space forward if null).
        public Transform m_Camera;                // Reference to the camera to determine which way the player is facing.
        public Renderer[] m_ArrowRenderers;       // Reference to the renderers of the arrows used to fade them in and out.
